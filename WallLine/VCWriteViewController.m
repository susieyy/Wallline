...
#import "VCWriteViewController.h"

@interface VCWriteViewController ()
@property (weak, nonatomic) UITextView* viewForTextView;
@end

@implementation VCWriteViewController
...
{
    SS_MLOG(self);
    NSString* status = self.viewForTextView.text;
    [[MMRequestManager sharedManager] doPostObjectID:self.objectID status:status privacy:@"SELF"];
