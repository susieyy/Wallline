...
@interface UULikeCell () <RTLabelDelegate>
...
{
    static NSString* Identifier = @"UULikeCell";
    UULikeCell* cell = [tableView dequeueReusableCellWithIdentifier:Identifier];
    if (cell == nil) {
        cell = [[UULikeCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:Identifier];
    }
    return cell;
}
